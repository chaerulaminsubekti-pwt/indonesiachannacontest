...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        <div class="lg:col-span-1">
            ...
            @if (in_array($event->status, ['berjalan', 'approved']))
        ...
        <div class="lg:col-span-2">
            @php
                ...
                $katStyle = match ($kategori) {
                    ...
                    'series_icc', 'series icc' => ['bg' => 'bg-rose-600', 'icon' => 'M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm0 7v-7', 'label' => 'Series ICC'],
    ...
    <div x-data="{ tab: 'peserta' }">
        <div class="flex gap-1 mb-6 border-b border-gray-200">
            ...
            @endif
            @if ($hasBanding ?? false)
            <button @click="tab = 'banding'" :class="tab === 'banding' ? 'border-b-2 border-[#FF1A1A] text-[#FF1A1A]' : 'text-[#0A0A0A] hover:text-[#FF1A1A]'"
                class="px-4 py-2.5 text-sm font-medium transition-all rounded-t-lg">Hasil Banding</button>
            @endif
        ...
        @endif
        @if ($hasBanding ?? false)
        <div x-show="tab === 'banding'" x-cloak>
            <livewire:hasil-banding-publik :event="$event" />
        </div>
        @endif
